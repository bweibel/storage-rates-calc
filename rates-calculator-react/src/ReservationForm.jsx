...
const ReservationForm = ({ onFormSubmit, deliveryAddress, storageType }) => {
  ...
  return (
      ...
      <div className='form-group full'>
            ...
            <select class="" id="how-found" aria-invalid="false" name="how-found"><option value="">Please choose an option</option><option value="Website/Search Engine">Website/Search Engine</option><option value="Saw a Container at someone's House/Business">Saw a Container at someone's House/Business</option><option value="Smart Shopper">Smart Shopper</option><option value="Facebook">Facebook</option><option value="Yelp">Yelp</option><option value="NextDoor">NextDoor</option><option value="Other">Other</option></select>
          </div>
